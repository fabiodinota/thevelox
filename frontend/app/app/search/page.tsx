	...
	return (
		<div className="w-screen h-full overflow-hidden relative">
			<div
				...
				className="absolute left-1/2 -translate-x-1/2 top-5 z-[9999] backdrop-bl bg-white/20 flex justify-center items-center border border-gray-100 px-[10px] w-[90%] max-w-[900px] h-[80px] rounded-xl"
			>
				<input
