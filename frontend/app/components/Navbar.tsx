            ...
            {openMobileNav && (
                <motion.nav variants={navVariant} initial="initial" animate="animate" exit="exit" className='fixed top-0 left-0 w-screen h-screen bg-background z-[998] flex flex-col justify-between items-center'>
                    <ul className='flex flex-col w-full gap-10 px-5 mt-[130px]'>
                        ...
                        <motion.li onClick={handleClose} variants={liVariant} transition={{ duration: 0.3, delay: openMobileNav ? 0.2 : 0.4, ease: customease }} className='flex items-center w-full flex-col gap-10'>
                        ...
                        <motion.li onClick={handleClose} variants={liVariant} transition={{ duration: 0.3, delay: openMobileNav ? 0.1 : 0.5, ease: customease }} className='flex items-center w-full flex-col gap-10'>
                        ...
                        <motion.li onClick={handleClose} variants={liVariant} transition={{ duration: 0.3, delay: openMobileNav ? 0 : 0.6, ease: customease }} className='flex items-center w-full flex-col gap-10'>
