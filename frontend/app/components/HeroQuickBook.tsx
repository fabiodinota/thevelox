                ...
                <div className="flex flex-col md:flex-row space-y-2.5 md:space-y-0 md:gap-2.5">
                    ...
                    <div className="relative w-full">
                        ...
                        <div className="w-12 flex-shrink-0 h-12 grid place-content-center relative">
                            ...
                            <path d="M2 20.167C1.45 20.167 0.979167 19.9712 0.5875 19.5795C0.195833 19.1878 0 18.717 0 18.167V4.16699C0 3.61699 0.195833 3.14616 0.5875 2.75449C0.979167 2.36283 1.45 2.16699 2 2.16699H3V0.166992H5V2.16699H13V0.166992H15V2.16699H16C16.55 2.16699 17.0208 2.36283 17.4125 2.75449C17.8042 3.14616 18 3.61699 18 4.16699V18.167C18 18.717 17.8042 19.1878 17.4125 19.5795C17.0208 19.9712 16.55 20.167 16 20.167H2ZM2 18.167H16V8.16699H2V18.167ZM2 6.16699H16V4.16699H2V6.16699Z" className="fill-foreground"/>
                            </svg>
