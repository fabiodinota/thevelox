    ...
    <div className='flex justify-center items-center w-full px-5 xl:px-10 flex-col py-10'>
         <section className="max-w-[1400px] w-full flex flex-col justify-center items-center gap-10 lg:gap-5 mt-[120px] xl:mt-[100px]">
            <div className="w-full flex flex-col-reverse xl:flex-row justify-center items-center gap-5 xl:gap-10">
                ...
                >
                    <span className="text-[20px] font-regular opacity-50">Placeholder Image</span>
                </div>
                <div 
                    data-aos="fade-down"
                    data-aos-duration="600"
                ...
                >
                    <h1 className="text-foreground text-[28px] sm:text-[32px] md:text-[42px] font-bold w-full text-left">Next-Generation Public Transport Booking App</h1>
        ...
        <section className="max-w-[1400px] w-full flex flex-col justify-center items-center gap-10 mt-[100px]">
                    ...
                    <div className='w-full flex flex-col gap-10 justify-center items-start'>
                         <div
                            ...
                            ref={firstRef}
                         >
                            <span className='text-gradient text-[24px] md:text-[36px] font-medium leading-tight'>2020</span>
                            <h3 className='text-[20px] md:text-[28px] font-bold'>The Devastating Effects Of Climate Change</h3>
                         ...
                         >
                            <motion.div style={{ scaleY: first.scrollYProgress, originY: "top" }} className="absolute top-0 left-[50%] w-[2px] h-full bg-[#E94537] rotate-180 opacity-100 z-10 block"></motion.div>
                         ...
                         <div
                            ...
                            ref={secondRef}
                         >
                            <span className='text-gradient text-[24px] md:text-[36px] font-medium leading-tight'>2021</span>
                            <h3 className='text-[20px] md:text-[28px] font-bold'>Start Of R&D On Sustainable Transit</h3>
                            <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
                                Lorem ipsum dolor sit amet consectetur. Habitasse rhoncus quam augue a nam odio massa turpis. Ultrices eleifend sapien turpis auctor augue ut. Iaculis non sit porttitor at dui tellus. Nulla facilisis magna feugiat volutpat.
                            </p>
                         </div>
                         <div
                            ...
                            className="relative h-32 w-1 grid place-content-center"
                         >
                            <motion.div style={{ scaleY: second.scrollYProgress, originY: "top" }} className="absolute top-0 left-[50%] w-[2px] h-full bg-[#E94537] rotate-180 opacity-100 z-10 block"></motion.div>
                            <div className="absolute top-0 left-[50%] w-[2px] h-full bg-foreground opacity-30 z-0 block"></div>
                        </div>
                         <div
                            data-aos="fade-up"
                            ...
                            ref={thirdRef}
                         >
                            <span className='text-gradient text-[24px] md:text-[36px] font-medium leading-tight'>2023, October</span>
                            <h3 className='text-[20px] md:text-[28px] font-bold'>Birth Of New Atlantis</h3>
                            <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
                                Lorem ipsum dolor sit amet consectetur. Habitasse rhoncus quam augue a nam odio massa turpis. Ultrices eleifend sapien turpis auctor augue ut. Iaculis non sit porttitor at dui tellus. Nulla facilisis magna feugiat volutpat.
                            </p>
                         </div>
                         <div
                            ...
                            className="relative h-32 w-1 grid place-content-center"
                         >
                            <motion.div style={{ scaleY: third.scrollYProgress, originY: "top" }} className="absolute top-0 left-[50%] w-[2px] h-full bg-[#E94537] rotate-180 opacity-100 z-10 block"></motion.div>
                            <div className="absolute top-0 left-[50%] w-[2px] h-full bg-foreground opacity-30 z-0 block"></div>
                        </div>
                         <div
                            data-aos="fade-up"
                            ...
                            data-aos-ease="ease-out" 
                        >
                            <span className='text-gradient text-[24px] md:text-[36px] font-medium leading-tight'>2024</span>
                            <h3 className='text-[20px] md:text-[28px] font-bold'>Mass Construction Sustainable Trains</h3>
                            <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
                                Lorem ipsum dolor sit amet consectetur. Habitasse rhoncus quam augue a nam odio massa turpis. Ultrices eleifend sapien turpis auctor augue ut. Iaculis non sit porttitor at dui tellus. Nulla facilisis magna feugiat volutpat.
                            </p>
                         </div>
        ...
        <section className="max-w-[1400px] w-full flex flex-col justify-center items-center gap-10 mt-[100px]">
            ...
            <div className='w-full h-full grid place-content-center grid-cols-1 md:grid-cols-2 grid-rows-4 md:grid-rows-2 gap-4'>
                <div className='bg-secondary rounded-xl w-full h-full flex flex-col justify-center items-start px-5 md:px-10'>
                    <div  
                        data-aos="fade-down"
                        data-aos-duration="600"
                        data-aos-once="true"
                        data-aos-ease="ease-out"
                        className="relative z-10 flex flex-col gap-5 sm:gap-10 h-full max-w-full xl:max-w-[700px] justify-center items-start"
                    >
                        <svg className="flex-shrink-0 w-[100px] sm:w-[184px] h-[100px] sm:h-[134px]" width="184" height="134" viewBox="0 0 184 134" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M104.501 79.4997C97.5562 79.4997 91.6534 77.0691 86.7923 72.208C81.9312 67.3469 79.5006 61.4441 79.5006 54.4997C79.5006 47.5552 81.9312 41.6525 86.7923 36.7913C91.6534 31.9302 97.5562 29.4997 104.501 29.4997C111.445 29.4997 117.348 31.9302 122.209 36.7913C127.07 41.6525 129.501 47.5552 129.501 54.4997C129.501 61.4441 127.07 67.3469 122.209 72.208C117.348 77.0691 111.445 79.4997 104.501 79.4997ZM37.834 108.666C34.3965 108.666 31.4538 107.442 29.0059 104.994C26.5579 102.547 25.334 99.6038 25.334 96.1663V12.833C25.334 9.39551 26.5579 6.4528 29.0059 4.00488C31.4538 1.55697 34.3965 0.333008 37.834 0.333008H171.167C174.605 0.333008 177.548 1.55697 179.995 4.00488C182.443 6.4528 183.667 9.39551 183.667 12.833V96.1663C183.667 99.6038 182.443 102.547 179.995 104.994C177.548 107.442 174.605 108.666 171.167 108.666H37.834ZM58.5856 94.1681C58.6773 95.2689 59.5627 96.1663 60.6673 96.1663H148.334C149.439 96.1663 150.324 95.2689 150.416 94.1681C150.83 89.1986 152.816 84.9341 156.376 81.3747C159.935 77.8152 164.2 75.8286 169.169 75.4147C170.27 75.323 171.167 74.4376 171.167 73.333V35.6663C171.167 34.5618 170.27 33.6763 169.169 33.5847C164.2 33.1708 159.935 31.1841 156.376 27.6247C152.816 24.0652 150.83 19.8008 150.416 14.8312C150.324 13.7305 149.439 12.833 148.334 12.833H60.6673C59.5627 12.833 58.6773 13.7305 58.5856 14.8312C58.1717 19.8008 56.1851 24.0652 52.6256 27.6247C49.0662 31.1841 44.8017 33.1708 39.8322 33.5847C38.7315 33.6763 37.834 34.5618 37.834 35.6663V73.333C37.834 74.4376 38.7315 75.323 39.8322 75.4147C44.8017 75.8286 49.0662 77.8152 52.6256 81.3747C56.1851 84.9341 58.1717 89.1986 58.5856 94.1681ZM158.667 131.666C158.667 132.771 157.772 133.666 156.667 133.666H12.834C9.39648 133.666 6.45378 132.442 4.00586 129.994C1.55794 127.547 0.333984 124.604 0.333984 121.166V27.333C0.333984 26.2284 1.22941 25.333 2.33398 25.333H10.834C11.9386 25.333 12.834 26.2284 12.834 27.333V119.166C12.834 120.271 13.7294 121.166 14.834 121.166H156.667C157.772 121.166 158.667 122.062 158.667 123.166V131.666Z" fill="url(#paint0_linear_239_467)"/>
                            <defs>
                            <linearGradient id="paint0_linear_239_467" x1="23.2689" y1="184.784" x2="243.071" y2="49.5941" gradientUnits="userSpaceOnUse">
                        ...
                        <div className="flex flex-col gap-1 w-full">
                            <h1 className="text-[20px] md:text-[28px] font-bold leading-relaxed">1. Affordability</h1>
                ...
                <div className='bg-secondary rounded-xl w-full h-full flex flex-col justify-center items-start px-5 md:px-10'>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-1 w-full">
                            <h1 className="text-[24px] md:text-[28px] font-bold leading-relaxed">2. Reliability</h1>
                            <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
                            Lorem ipsum dolor sit amet consectetur. Habitasse rhoncus quam augue a nam odio massa turpis. Ultrices eleifend sapien turpis auctor augue ut.
                            </p>
                        </div>
                ...
                <div className='bg-secondary rounded-xl w-full h-full flex flex-col justify-center items-start px-5 md:px-10'>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-1 w-full">
                            <h1 className="text-[24px] md:text-[28px] font-bold leading-relaxed">3. Accessibility</h1>
                            <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
                                Lorem ipsum dolor sit amet consectetur. Habitasse rhoncus quam augue a nam odio massa turpis. Ultrices eleifend sapien turpis auctor augue ut.
                            </p>
                        </div>
                ...
                <div className='bg-secondary rounded-xl w-full h-full flex flex-col justify-center items-start px-5 md:px-10'>
                    <div
                        ...
                        className="relative z-10 flex flex-col gap-5 sm:gap-10 max-w-full xl:max-w-[700px] justify-center items-start"
                    >
                        <svg className="flex-shrink-0  w-[100px] sm:w-[141px] h-[100px] sm:h-[143px]" width="141" height="143" viewBox="0 0 141 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                        <linearGradient id="paint0_linear_239_508" x1="17.5946" y1="196.62" x2="211.689" y2="110.383" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#E42B2B"/>
                        <stop offset="0.17" stopColor="#E42F2C"/>
                        <stop offset="0.35" stopColor="#E73B32"/>
                        <stop offset="0.53" stopColor="#EB503C"/>
                        ...
                        <div className="flex flex-col gap-1 w-full">
                            <h1 className="text-[24px] md:text-[28px] font-bold leading-relaxed">4. Sustainability</h1>
                            <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
                                Lorem ipsum dolor sit amet consectetur. Habitasse rhoncus quam augue a nam odio massa turpis. Ultrices eleifend sapien turpis auctor augue ut.
                            </p>
                        </div>
