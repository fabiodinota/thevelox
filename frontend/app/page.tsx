		...
		<div>
            ...
            <div className="flex flex-col justify-center items-center py-10 px-5 md:px-10">
                ...
                <section className="max-w-[1400px] w-full flex flex-col justify-center items-center gap-5">
                    <h1 className="text-foreground text-[28px] sm:text-[32px] md:text-[40px] font-bold w-full text-left">The Velox, Electricity In Its Veins.</h1>
                    <div className="rounded-[20px] bg-secondary w-full aspect-video grid place-content-center">
                ...
                <section className="max-w-[1400px] relative w-full flex flex-col items-center gap-5 mt-[100px] overflow-hidden">
                    <h1 className="text-foreground text-[28px] sm:text-[32px] md:text-[40px] font-bold w-full text-left">Our Core Principles</h1>
                    <div className="w-full h-[2000px] relative flex flex-col items-center gap-[250px]">
                        <div className="relative z-10 flex flex-row gap-10 max-w-[700px] justify-center items-center self-start pl-10 mt-10">
                            <svg className="flex-shrink-0" width="184" height="134" viewBox="0 0 184 134" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex flex-col gap-1 w-full">
                                <h1 className="text-[24px] md:text-[28px] font-bold leading-relaxed">1. Affordability</h1>
                                <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
                                    Lorem ipsum dolor sit amet consectetur. Habitasse rhoncus quam augue a nam odio massa turpis. Ultrices eleifend sapien turpis auctor augue ut. Iaculis non sit porttitor at dui tellus.
                                </p>
                            </div>
                        </div>
                        <div className="relative z-10 flex flex-row gap-10 max-w-[800px] justify-center items-center pr-10 mt-10 self-end">
                            <svg className="flex-shrink-0" width="184" height="174" viewBox="0 0 184 174" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="relative z-10 flex flex-row gap-10 max-w-[800px] justify-center items-center pl-10 mt-5 self-start">
                            <svg className="flex-shrink-0" width="163" height="168" viewBox="0 0 163 168" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="absolute hidden dark:block z-[1] top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-full max-w-[1400px] h-[2000px]">
                            <div className="w-full h-[200px] bg-gradient-to-b from-[#121212] to-[#12121200] absolute top-0"></div>
                            <div className="w-[100px] h-full bg-gradient-to-l from-[#121212] to-[#12121200] absolute right-0"></div>
                            <div className="w-[100px] h-full bg-gradient-to-r from-[#121212] to-[#12121200] absolute left-0"></div>
                            <div className="w-full h-[200px] bg-gradient-to-t from-[#121212] to-[#12121200] absolute bottom-0 "></div>
                        </div>
                        <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-[1400px] h-[2000px]">
