    ...
    <div className="flex justify-center items-center w-full px-5 xl:px-10 flex-col py-10">
      <section className="max-w-[1400px] w-full flex flex-col justify-center items-center gap-10 lg:gap-5 mt-[120px] xl:mt-[100px]">
        <div className="w-full flex flex-col-reverse xl:flex-row justify-center items-center gap-5 xl:gap-10">
          ...
          >
            <Image
              src="https://storage.thevelox.fabiodinota.com/booking.webp"
              alt="Thumbnail"
          ...
          >
            ...
            <p className="text-foreground text-[16px] md:text-[18px] font-normal leading-relaxed">
              ...
              next-generation booking app, where convenience and efficiency are
              paramount. Our app seamlessly integrates with all levels of
              accessibility, reliability and sustainability, making every trip
              smooth. Book your next trip with one click and experience how easy
              and fast public transportation in New Atlantis can be.
            </p>
          </div>
        </div>
      </section>
      <section className="max-w-[1400px] w-full flex flex-col justify-center items-center gap-10 mt-[100px]">
        ...
        <div className="w-full flex flex-col gap-10 justify-center items-start">
          ...
          >
            <div>
              ...
              <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
                The year 2020 marked a turning point as devastating climate
                events underscored the critical need for sustainable practices.
                Governments and industries acknowledged the imperative shift
                required to protect our planet.
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
              In response to the escalating environmental crisis, 2021 saw the
              launch of intensive research and development in sustainable
              transportation. This global collaboration aimed to dramatically
              decrease carbon emissions and enhance efficiency.
            </p>
          </div>
          <div
            data-aos="fade-up"
          ...
          >
            ...
            <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
              October 2023 witnessed the groundbreaking inauguration of New
              Atlantis, an underwater city designed for complete sustainability.
              This project integrated the latest technologies with environmental
              science to create a blueprint for future urban living.
            </p>
          </div>
          <div
            data-aos="fade-up"
          ...
          >
            ...
            <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
              Infrastructure The construction of New Atlantis’s eco-friendly
              infrastructure began in 2024, focusing on carbon-neutral trains
              powered by renewable energies. This initiative set new standards
            ...
            >
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <p className="text-[16px] md:text-[18px] font-light leading-relaxed">
                  At The Velox, affordability is key, making sustainable
                  transportation accessible to everyone. We ensure that
                  environmentally friendly travel remains a viable option for
          ...
          <div className="bg-secondary rounded-xl overflow-hidden w-full h-full flex flex-col justify-center items-start px-5 md:px-10">
            ...
            >
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
                  The Velox is committed to reliability in public
                  transportation, always providing punctual and efficient
                  service. Our commitment ensures that you can always count on
                  us, which is essential to daily life in New Atlantis.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-secondary rounded-xl overflow-hidden w-full h-full flex flex-col justify-center items-start px-5 md:px-10">
            ...
            >
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
                  Accessibility is crucial at The Velox, where our
                  transportation is designed to be user-friendly for everyone,
                  regardless of age or mobility impairment. This keeps every
                  corner of New Atlantis accessible to all residents.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-secondary rounded-xl overflow-hidden w-full h-full flex flex-col justify-center items-start px-5 md:px-10">
            ...
            >
              ...
              <div className="flex flex-col gap-1 w-full">
                ...
                <p className="text-[16px] md:text-[18px] font-normal leading-relaxed">
                  Sustainability is crucial to The Velox, with our commitment to
                  carbon-neutral transportation solutions that protect the
                  environment. In this way, New Atlantis remains at the
                  forefront of environmental responsibility.
                </p>
              </div>
            </div>
          </div>
