	...
	return (
		<div className="overflow-hidden">
            <div className="w-full min-h-[600px] h-[600px] sm:h-[650px] md:h-[50vh] max-h-[700px] relative flex justify-center items-center flex-col px-5 xl:px-10">
                ...
                <motion.div initial={{ y: -100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.4, ease: customease, delay: 0 }}  className="w-full min-h-[600px] h-[600px] sm:h-[650px] md:h-[50vh] max-h-[700px] xl:rounded-b-[75px] overflow-hidden absolute top-0 left-0 z-0">
            ...
            <div className="flex flex-col justify-center items-center py-10 px-5 md:px-10">
                ...
                <section className="max-w-[1400px] w-full flex flex-col justify-center items-center gap-5">
                    ...
                    <motion.div initial={{ y: -100, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.4, ease: customease, delay: 0.4 }} className="relative rounded-[20px] overflow-hidden bg-secondary w-full aspect-video grid place-content-center group">
                ...
                <section className="max-w-[1400px] w-full flex flex-col justify-center items-center gap-10 lg:gap-5 mt-[100px]">
                    <div className="w-full flex flex-col lg:flex-row justify-center items-center gap-5 lg:gap-10">
                        ...
                        >
                            <img src='https://storage.thevelox.co/0476.png' alt='Thumbnail' className="w-full h-full object-cover aspect-video" />
                        </div>
                    </div>
                    <div className="w-full flex flex-col-reverse lg:flex-row justify-center items-center gap-5 lg:gap-10">
                        <div 
                            ...
                            className="rounded-[20px] bg-secondary w-full aspect-video grid place-content-center overflow-hidden"
                        >
                            <img src='https://storage.thevelox.co/0741.png' alt='Thumbnail' className="w-full h-full object-cover aspect-video" />
                        </div>
                        <div 
                            data-aos="fade-left"
                            data-aos-duration="600"
